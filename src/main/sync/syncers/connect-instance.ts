...
const connectInstanceSyncer: ResourceSyncer = {
    service: 'connect',
    ...
    async push(
        ...
        void targetClient
        void sourceData
        // TODO: implement push using CreateInstanceCommand / UpdateInstanceAttributeCommand
        return { ok: false, changes, skipped, error: 'Not implemented' }
    }
}

registerSyncer('connect:instance', connectInstanceSyncer)
