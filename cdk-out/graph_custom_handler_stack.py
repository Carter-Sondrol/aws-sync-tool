...
class GraphCustomHandlerStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs):
        ...
        # Handler path points to dedicated subfolder (avoids recursive cdk.out copy)
        handler_path = str(Path(__file__).parent / "lambda_code")

        fn = _lambda.Function(
            self, "GraphCustomHandler",
            runtime=_lambda.Runtime.PYTHON_3_12,  # ✅ safer version than 3.13 for now
