...
class GraphStack(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs):
        ...
        self.ConnectHoursUltimate = connect.CfnHoursOfOperation(
            self,
            "ConnectHoursUltimate",
            name="Ultimate",
            description="Ultimate - Regular Business Hours",
            config=[
                connect.CfnHoursOfOperation.HoursOfOperationConfigProperty(
                    day="MONDAY",
                    start_time=connect.CfnHoursOfOperation.HoursOfOperationTimeSliceProperty(hours=8, minutes=0),
                    end_time=connect.CfnHoursOfOperation.HoursOfOperationTimeSliceProperty(hours=20, minutes=0),
                ),
                connect.CfnHoursOfOperation.HoursOfOperationConfigProperty(
                    day="TUESDAY",
                    start_time=connect.CfnHoursOfOperation.HoursOfOperationTimeSliceProperty(hours=8, minutes=0),
        ...
        # --- After-hours windows ---
        self.ConnectHoursUltimate_After_Hours = connect.CfnHoursOfOperation(
            self,
            "ConnectHoursUltimateAfterHours",
            name="Ultimate After Hours",
            description="Ultimate After Hours",
            config=[
                # Monday 00:00–08:00
                connect.CfnHoursOfOperation.HoursOfOperationConfigProperty(
                    day="MONDAY",
                    start_time=connect.CfnHoursOfOperation.HoursOfOperationTimeSliceProperty(hours=0, minutes=0),
                    end_time=connect.CfnHoursOfOperation.HoursOfOperationTimeSliceProperty(hours=8, minutes=0),
                ),
                # Monday 20:00–23:59
                connect.CfnHoursOfOperation.HoursOfOperationConfigProperty(
                    day="MONDAY",
                    start_time=connect.CfnHoursOfOperation.HoursOfOperationTimeSliceProperty(hours=20, minutes=0),
                    end_time=connect.CfnHoursOfOperation.HoursOfOperationTimeSliceProperty(hours=23, minutes=59),
                ),
                # Sunday 00:00–11:59
                connect.CfnHoursOfOperation.HoursOfOperationConfigProperty(
                    day="SUNDAY",
                    start_time=connect.CfnHoursOfOperation.HoursOfOperationTimeSliceProperty(hours=0, minutes=0),
                    end_time=connect.CfnHoursOfOperation.HoursOfOperationTimeSliceProperty(hours=11, minutes=59),
                ),
        ...
        self.ConnectFlow1__Ultimate_Entry = connect.CfnContactFlow(
            self,
            "ConnectFlow1. Ultimate Entry",
            name="1. Ultimate Entry",
            type="CONTACT_FLOW",
            description="",
        ...
        self.UltimateEnglish = connect.CfnQueue(
            self,
            "UltimateEnglish",
            ...
            outbound_caller_config={
                ...
                "OutboundFlowId": "75b8e03f-f5c4-47d7-bb54-89fc84e66ffa",
            },
            tags=[],
            hours_of_operation_arn=self.ConnectHoursUltimate.attr_hours_of_operation_arn,
        )

        self.ConnectPromptUltimate_Language_Selection = connect.CfnPrompt(
            self,
            "ConnectPromptUltimate Language Selection",
        ...
        self.UltimateAfterHoursEnglish = connect.CfnQueue(
            self,
            ...
            tags=[],
            hours_of_operation_arn=self.ConnectHoursUltimate_After_Hours.attr_hours_of_operation_arn,
        )

        self.UltimateSpanish = connect.CfnQueue(
            self,
            "UltimateSpanish",
        ...
        self.UltimateAfterHoursSpanish = connect.CfnQueue(
            self,
        ...
        self.LexAliasPROD = aws_lex.CfnBotAlias(
            self,
            "LexAliasPROD",
            bot_alias_name="PROD",
            bot_id="JH5QVDICLV",
            ...
            bot_alias_locale_settings=[
                aws_lex.CfnBotAlias.BotAliasLocaleSettingsItemProperty(
                    locale_id="en_US", bot_alias_locale_setting={"enabled": True}
                ),
                aws_lex.CfnBotAlias.BotAliasLocaleSettingsItemProperty(
                    locale_id="es_US", bot_alias_locale_setting={"enabled": True}
                ),
            ],
            conversation_log_settings=aws_lex.CfnBotAlias.ConversationLogSettingsProperty(
                text_log_settings=[
                    aws_lex.CfnBotAlias.TextLogSettingProperty(
                        enabled=True,
                        destination=aws_lex.CfnBotAlias.TextLogDestinationProperty(
                            cloud_watch=aws_lex.CfnBotAlias.CloudWatchLogGroupLogDestinationProperty(
                ...
                audio_log_settings=[
                    aws_lex.CfnBotAlias.AudioLogSettingProperty(
                        enabled=True,
        ...
        self.LogsGroupBotLogs = aws_logs.CfnLogGroup(
            self, "LogsGroupBotLogs", log_group_name="BotLogs"
        )
        ...
        lex_bot_role = iam.Role(
            ...
            description="Execution role for Lex V2 bot build/run",
        )

        # Minimal examples — scope these to your actual resources!
        lex_bot_role.add_to_policy(
            iam.PolicyStatement(
                ...
                resources=["*"],  # tighten to your log group if known
            )
        )
        lex_bot_role.add_to_policy(
            iam.PolicyStatement(
        ...
        self.LexBotUltimate_Intent_Capture_2 = aws_lex.CfnBot(
            self,
            "LexBotUltimate-Intent-Capture-2",
            name="Ultimate-Intent-Capture-2",
            role_arn=lex_bot_role.role_arn,  # <- now provided
            data_privacy={"childDirected": False},
            idle_session_ttl_in_seconds=300,
        )

        self.LexLocaleen_US = aws_cdk.CfnCustomResource(
            self,
            "LexLocaleen_US",
  ...
  "voice_settings": {
    ...
    "engine": "neural"
            ...
            self.LexLocaleen_US.add_property_override(k, v)
        self.LexLocaleen_US.add_property_override("Service", "lex")
        self.LexLocaleen_US.add_property_override("OriginalType", "AWS::Lex::BotLocale")

        self.LexLocalees_US = aws_cdk.CfnCustomResource(
            self,
            "LexLocalees_US",
            service_token=self.custom_handler_arn.value_as_string,
        )
  ...
  "voice_settings": {
    ...
    "engine": "neural"
            ...
            self.LexLocalees_US.add_property_override(k, v)
        self.LexLocalees_US.add_property_override("Service", "lex")
        self.LexLocalees_US.add_property_override("OriginalType", "AWS::Lex::BotLocale")

        self.BedrockModelanthropic_claude_3_sonnet_20240229_v1_0 = (
            aws_cdk.CfnCustomResource(
                self,
                "BedrockModelanthropic.claude_3_sonnet_20240229_v1_0",
                service_token=self.custom_handler_arn.value_as_string,
            )
        )
        for k, v in json.loads(
  ...
  "arn": "__REF_BedrockModelanthropic.claude_3_sonnet_20240229_v1_0__",
  "description": "Reference-only Bedrock foundation model"
}"""
        ).items():
            self.BedrockModelanthropic_claude_3_sonnet_20240229_v1_0.add_property_override(
                k, v
            )
        self.BedrockModelanthropic_claude_3_sonnet_20240229_v1_0.add_property_override(
            "Service", "bedrock"
        ...
        self.BedrockModelanthropic_claude_3_sonnet_20240229_v1_0.add_property_override(
            "OriginalType", "Unresolved::BedrockModel"
        )

        self.LexIntentRideStatus = aws_cdk.CfnCustomResource(
            self,
            "LexIntentRideStatus",
            service_token=self.custom_handler_arn.value_as_string,
        )
  ...
  "bot_id": "JH5QVDICLV",
  "locale_id": "en_US",
  "intent_name": "RideStatus",
  "description": null,
  "sample_utterances": [
    {
      "utterance": "Where is my ride"
    },
    {
      "utterance": "What's the status of my ride "
    },
    {
      "utterance": "Check my ride status Is my ride confirmed"
    },
    {
      "utterance": "Do I have a ride scheduled"
    },
    {
      "utterance": "who is picking me up"
    },
    {
      "utterance": "When is my ride"
    },
    {
      "utterance": "What rides do I have coming up"
    },
    {
      "utterance": "Tell me about my reservation"
    },
    {
      "utterance": "Has my ride been scheduled "
    },
    {
      "utterance": "Check my booking"
    },
    {
      "utterance": "What's my ride information"
    },
    {
      "utterance": "Can you confirm I have transport arranged"
    },
    {
      "utterance": "Do you show a ride for me"
    },
    {
      "utterance": "is my ride booked for today"
    },
    {
      "utterance": "can you confirm my transportation"
    },
    {
      "utterance": "ride status"
    },
    {
      "utterance": "status of my ride"
    }
  ],
  "dialog_code_hook": null,
  "fulfillment_code_hook": null,
  "slot_priorities": [],
  "intent_closing_setting": null,
  "intent_confirmation_setting": null,
  "input_contexts": null,
  "output_contexts": null
}"""
        ).items():
            self.LexIntentRideStatus.add_property_override(k, v)
        self.LexIntentRideStatus.add_property_override("Service", "lex")
        self.LexIntentRideStatus.add_property_override(
            "OriginalType", "AWS::Lex::Intent"
        )

        self.LexIntentReservation = aws_cdk.CfnCustomResource(
            self,
            "LexIntentReservation",
            service_token=self.custom_handler_arn.value_as_string,
        )
        for k, v in json.loads(
            r"""{
  "bot_id": "JH5QVDICLV",
  "locale_id": "en_US",
  "intent_name": "Reservation",
  "description": null,
  "sample_utterances": [
    {
      "utterance": "I need a ride "
    },
    {
      "utterance": "Schedule a ride"
    },
    {
      "utterance": "Book a ride for tomorrow "
    },
    {
      "utterance": "Can you arrange transportation for me"
    },
    {
      "utterance": "I need to get to my doctor's appointment "
    },
    {
      "utterance": "Book a medical transport "
    },
    {
      "utterance": "I need a ride as soon as possible"
    },
    {
      "utterance": "Reserve a ride "
    },
    {
      "utterance": "Can I get a ride today"
    },
    {
      "utterance": "I need transportation "
    },
    {
      "utterance": "Set up a ride for me "
    },
    {
      "utterance": "Get me a ride to the hospital"
    },
    {
      "utterance": "Get me a ride to my doctor"
    },
    {
      "utterance": "I have an appointment and need a ride "
    },
    {
      "utterance": "Can you schedule a pickup "
    },
    {
      "utterance": "reservation"
    },
    {
      "utterance": "reserve my transportation"
    },
    {
      "utterance": "i need an uber scheduled"
    }
  ],
  "dialog_code_hook": null,
  "fulfillment_code_hook": null,
  ...
  "output_contexts": null
            ...
            self.LexIntentReservation.add_property_override(k, v)
        self.LexIntentReservation.add_property_override("Service", "lex")
        self.LexIntentReservation.add_property_override(
            "OriginalType", "AWS::Lex::Intent"
        )

        self.LexIntentCancelRide = aws_cdk.CfnCustomResource(
            self,
            "LexIntentCancelRide",
            service_token=self.custom_handler_arn.value_as_string,
        )
  ...
  "bot_id": "JH5QVDICLV",
  "locale_id": "en_US",
  "intent_name": "CancelRide",
  "description": null,
  "sample_utterances": [
    {
      "utterance": "I need to cancel "
    },
    {
      "utterance": "Cancel my reservation "
    },
    {
      "utterance": "I don't need the ride anymore "
    },
    {
      "utterance": "Remove my booking "
    },
    {
      "utterance": "Remove my reservation"
    },
    {
      "utterance": "Cancel upcoming ride "
    },
    {
      "utterance": "I want to cancel my ride for today"
    },
    {
      "utterance": "can i cancel my ride same day"
    },
    {
      "utterance": "Delete my reservation "
    },
    {
      "utterance": "Cancel my appointment ride "
    },
    {
      "utterance": "I need to cancel my pickup "
    },
    {
      "utterance": "Cancel transportation "
    },
    {
      "utterance": "I booked a ride but I won't be needing it anymore"
    },
    {
      "utterance": "I found another way to my apointment"
    },
    {
      "utterance": "forget about my ride"
    },
    {
      "utterance": "i need to call off my trip"
    },
    {
      "utterance": "Please dont send anyone"
    },
    {
      "utterance": "cancel my ride"
    },
    {
      "utterance": "cancel my transportation"
    }
  ],
  "dialog_code_hook": null,
  "fulfillment_code_hook": null,
  ...
  "output_contexts": null
            ...
            self.LexIntentCancelRide.add_property_override(k, v)
        self.LexIntentCancelRide.add_property_override("Service", "lex")
        self.LexIntentCancelRide.add_property_override(
            "OriginalType", "AWS::Lex::Intent"
        )

        self.LexIntentModifyRide = aws_cdk.CfnCustomResource(
            self,
            "LexIntentModifyRide",
            service_token=self.custom_handler_arn.value_as_string,
        )
  ...
  "bot_id": "JH5QVDICLV",
  "locale_id": "en_US",
  "intent_name": "ModifyRide",
  "description": null,
  "sample_utterances": [
    {
      "utterance": "I need to change my ride "
    },
    {
      "utterance": "Modify my reservation "
    },
    {
      "utterance": "Can I reschedule my ride "
    },
    {
      "utterance": "Change pickup time "
    },
    {
      "utterance": "Update my ride details "
    },
    {
      "utterance": "I need to change my pickup location "
    },
    {
      "utterance": "Can I change my appointment time "
    },
    {
      "utterance": "Reschedule my ride "
    },
    {
      "utterance": "Edit my booking "
    },
    {
      "utterance": "Change my ride time "
    },
    {
      "utterance": "edit my apointment"
    },
    {
      "utterance": "modify my ride"
    },
    {
      "utterance": "Update pickup address"
    },
    {
      "utterance": "I need to change the destination "
    },
    {
      "utterance": "Modify my pickup time"
    },
    {
      "utterance": "I need to change my address"
    },
    {
      "utterance": "Modify my ride"
    },
    {
      "utterance": "I just called to make a ride but can we make it later"
    },
    {
      "utterance": "the time I made for my ride isn't going to work for me"
    },
    {
      "utterance": "I reserved a ride but need to go somewhere else"
    },
    {
      "utterance": "can we move my reservation back an hour"
    },
    {
      "utterance": "I booked a ride but I need the address needs to be different"
    },
    {
      "utterance": "Can you make changes to my booking"
    },
    {
      "utterance": "modify transportation"
    },
    {
      "utterance": "modify ride"
    }
  ],
  "dialog_code_hook": null,
  "fulfillment_code_hook": null,
  ...
  "output_contexts": null
            ...
            self.LexIntentModifyRide.add_property_override(k, v)
        self.LexIntentModifyRide.add_property_override("Service", "lex")
        self.LexIntentModifyRide.add_property_override(
            "OriginalType", "AWS::Lex::Intent"
        )

        self.LexIntentRescueRide = aws_cdk.CfnCustomResource(
            self,
            "LexIntentRescueRide",
            service_token=self.custom_handler_arn.value_as_string,
        )
  ...
  "bot_id": "JH5QVDICLV",
  "locale_id": "en_US",
  "intent_name": "RescueRide",
  "description": null,
  "sample_utterances": [
    {
      "utterance": "I was left behind "
    },
    {
      "utterance": "My driver didn't show up"
    },
    {
      "utterance": "I missed my ride "
    },
    {
      "utterance": "The driver left without me"
    },
    {
      "utterance": "I need emergency transportation"
    },
    {
      "utterance": "My ride never came "
    },
    {
      "utterance": "I was stranded "
    },
    {
      "utterance": "I need a rescue ride "
    },
    {
      "utterance": "The driver didn't wait "
    },
    {
      "utterance": "I need help I'm still here"
    },
    {
      "utterance": "Send another driver "
    },
    {
      "utterance": "My ride abandoned me "
    },
    {
      "utterance": "I need urgent pickup "
    },
    {
      "utterance": "no one has picked me up"
    },
    {
      "utterance": "i still need to get home"
    },
    {
      "utterance": "I am stuck here"
    },
    {
      "utterance": "They forgot about me"
    },
    {
      "utterance": "i was late and my driver left me"
    },
    {
      "utterance": "rescue ride"
    }
  ],
  "dialog_code_hook": null,
  "fulfillment_code_hook": null,
  ...
  "output_contexts": null
            ...
            self.LexIntentRescueRide.add_property_override(k, v)
        self.LexIntentRescueRide.add_property_override("Service", "lex")
        self.LexIntentRescueRide.add_property_override(
            "OriginalType", "AWS::Lex::Intent"
        )

        self.LexIntentFallbackIntent = aws_cdk.CfnCustomResource(
            self,
            "LexIntentFallbackIntent",
            service_token=self.custom_handler_arn.value_as_string,
        )
        for k, v in json.loads(
            r"""{
  ...
  "output_contexts": null
            ...
            self.LexIntentFallbackIntent.add_property_override(k, v)
        self.LexIntentFallbackIntent.add_property_override("Service", "lex")
        self.LexIntentFallbackIntent.add_property_override(
            "OriginalType", "AWS::Lex::Intent"
        )

        self.LexIntentDriverStatus = aws_cdk.CfnCustomResource(
            self,
            "LexIntentDriverStatus",
            service_token=self.custom_handler_arn.value_as_string,
        )
        for k, v in json.loads(
            r"""{
  ...
  "sample_utterances": [
    ...
    {
      "utterance": "How far away is the driver "
    },
    {
      "utterance": "When will my driver arrive "
    },
    {
      "utterance": "What's the ETA"
    },
    {
      "utterance": "What's the Estimated time"
    },
    {
      "utterance": "How long until pickup "
    },
    {
      "utterance": "Is my driver on the way "
    },
    {
      "utterance": "Track my driver "
    },
    {
      "utterance": "How many minutes away is my driver "
    },
    {
      "utterance": "When will they get here "
    },
    {
      "utterance": "Is the driver close "
    },
    {
      "utterance": "How far is the driver"
    },
    {
      "utterance": "Give me driver location"
    },
    {
      "utterance": "Can you tell me when to expect them"
    },
    {
      "utterance": "how much longer until the driver gets here"
    },
    {
      "utterance": "i am outside waiting on my ride"
    },
    {
      "utterance": "driver status"
    }
  ],
  "dialog_code_hook": null,
  "fulfillment_code_hook": null,
  ...
  "output_contexts": null
            ...
            self.LexIntentDriverStatus.add_property_override(k, v)
        self.LexIntentDriverStatus.add_property_override("Service", "lex")
        self.LexIntentDriverStatus.add_property_override(
            "OriginalType", "AWS::Lex::Intent"
        )

        self.LexIntentFlexRideActivation = aws_cdk.CfnCustomResource(
            self,
            "LexIntentFlexRideActivation",
            service_token=self.custom_handler_arn.value_as_string,
        )
        for k, v in json.loads(
            r"""{
  "bot_id": "JH5QVDICLV",
  "locale_id": "en_US",
  "intent_name": "FlexRideActivation",
  "description": null,
  "sample_utterances": [
    {
      "utterance": "Activate flex ride"
    },
    {
      "utterance": "Turn on flex ride "
    },
    {
      "utterance": "Enable flex ride "
    },
    {
      "utterance": "I want to use flex ride"
    },
    {
      "utterance": "Set up flex ride "
    },
    {
      "utterance": "Start flex ride service "
    },
    {
      "utterance": "Enroll in flex ride"
    },
    {
      "utterance": "Can I activate flex ride "
    },
    {
      "utterance": "I need flex ride activated "
    },
    {
      "utterance": "Switch to flex ride "
    },
    {
      "utterance": "Enable my flex ride option"
    },
    {
      "utterance": "flex"
    },
  ...
  "output_contexts": null
            ...
            self.LexIntentFlexRideActivation.add_property_override(k, v)
        self.LexIntentFlexRideActivation.add_property_override("Service", "lex")
        self.LexIntentFlexRideActivation.add_property_override(
            "OriginalType", "AWS::Lex::Intent"
        )

        self.LexIntentAgent = aws_cdk.CfnCustomResource(
            self,
            "LexIntentAgent",
            service_token=self.custom_handler_arn.value_as_string,
        )
  ...
  "sample_utterances": [
    ...
    {
      "utterance": "I need to speak with an agent"
    },
    {
      "utterance": "person"
    },
  ...
  "output_contexts": null
            ...
            self.LexIntentAgent.add_property_override(k, v)
        self.LexIntentAgent.add_property_override("Service", "lex")
        self.LexIntentAgent.add_property_override("OriginalType", "AWS::Lex::Intent")
