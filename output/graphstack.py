from aws_cdk import (Stack, aws_connect, aws_dynamodb, aws_iam, aws_lambda, aws_lexv2, aws_logs, aws_s3)
...
class GraphStack(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs):
        ...
        self.LexIntentFlexRideActivation = aws_lexv2.CfnIntent(
            self, "LexIntentFlexRideActivation",
            bot_id="JH5QVDICLV",
            locale_id="en_US",
            intent_name="FlexRideActivation",
            description=None,
            sample_utterances=[{'utterance': 'Activate flex ride'}, {'utterance': 'Turn on flex ride '}, {'utterance': 'Enable flex ride '}, {'utterance': 'I want to use flex ride'}, {'utterance': 'Set up flex ride '}, {'utterance': 'Start flex ride service '}, {'utterance': 'Enroll in flex ride'}, {'utterance': 'Can I activate flex ride '}, {'utterance': 'I need flex ride activated '}, {'utterance': 'Switch to flex ride '}, {'utterance': 'Enable my flex ride option'}, {'utterance': 'flex'}, {'utterance': 'flex ride'}],
            dialog_code_hook=None,
            fulfillment_code_hook=None,
            slot_priorities=[],
            intent_closing_setting=None,
        ...
        self.LexIntentReservation = aws_lexv2.CfnIntent(
            self, "LexIntentReservation",
            bot_id="JH5QVDICLV",
            locale_id="en_US",
            intent_name="Reservation",
            description=None,
            sample_utterances=[{'utterance': 'I need a ride '}, {'utterance': 'Schedule a ride'}, {'utterance': 'Book a ride for tomorrow '}, {'utterance': 'Can you arrange transportation for me'}, {'utterance': "I need to get to my doctor's appointment "}, {'utterance': 'Book a medical transport '}, {'utterance': 'I need a ride as soon as possible'}, {'utterance': 'Reserve a ride '}, {'utterance': 'Can I get a ride today'}, {'utterance': 'I need transportation '}, {'utterance': 'Set up a ride for me '}, {'utterance': 'Get me a ride to the hospital'}, {'utterance': 'Get me a ride to my doctor'}, {'utterance': 'I have an appointment and need a ride '}, {'utterance': 'Can you schedule a pickup '}, {'utterance': 'reservation'}, {'utterance': 'reserve my transportation'}, {'utterance': 'i need an uber scheduled'}],
            dialog_code_hook=None,
            fulfillment_code_hook=None,
            slot_priorities=[],
            intent_closing_setting=None,
        ...
        self.LexIntentRescueRide = aws_lexv2.CfnIntent(
            self, "LexIntentRescueRide",
            bot_id="JH5QVDICLV",
            locale_id="en_US",
            intent_name="RescueRide",
            description=None,
            sample_utterances=[{'utterance': 'I was left behind '}, {'utterance': "My driver didn't show up"}, {'utterance': 'I missed my ride '}, {'utterance': 'The driver left without me'}, {'utterance': 'I need emergency transportation'}, {'utterance': 'My ride never came '}, {'utterance': 'I was stranded '}, {'utterance': 'I need a rescue ride '}, {'utterance': "The driver didn't wait "}, {'utterance': "I need help I'm still here"}, {'utterance': 'Send another driver '}, {'utterance': 'My ride abandoned me '}, {'utterance': 'I need urgent pickup '}, {'utterance': 'no one has picked me up'}, {'utterance': 'i still need to get home'}, {'utterance': 'I am stuck here'}, {'utterance': 'They forgot about me'}, {'utterance': 'i was late and my driver left me'}, {'utterance': 'rescue ride'}],
            dialog_code_hook=None,
            fulfillment_code_hook=None,
            slot_priorities=[],
            intent_closing_setting=None,
        ...
        self.LexIntentFallbackIntent = aws_lexv2.CfnIntent(
            self, "LexIntentFallbackIntent",
            bot_id="JH5QVDICLV",
            locale_id="en_US",
        ...
        self.LexIntentModifyRide = aws_lexv2.CfnIntent(
            self, "LexIntentModifyRide",
            bot_id="JH5QVDICLV",
            locale_id="en_US",
            intent_name="ModifyRide",
            description=None,
            sample_utterances=[{'utterance': 'I need to change my ride '}, {'utterance': 'Modify my reservation '}, {'utterance': 'Can I reschedule my ride '}, {'utterance': 'Change pickup time '}, {'utterance': 'Update my ride details '}, {'utterance': 'I need to change my pickup location '}, {'utterance': 'Can I change my appointment time '}, {'utterance': 'Reschedule my ride '}, {'utterance': 'Edit my booking '}, {'utterance': 'Change my ride time '}, {'utterance': 'edit my apointment'}, {'utterance': 'modify my ride'}, {'utterance': 'Update pickup address'}, {'utterance': 'I need to change the destination '}, {'utterance': 'Modify my pickup time'}, {'utterance': 'I need to change my address'}, {'utterance': 'Modify my ride'}, {'utterance': 'I just called to make a ride but can we make it later'}, {'utterance': "the time I made for my ride isn't going to work for me"}, {'utterance': 'I reserved a ride but need to go somewhere else'}, {'utterance': 'can we move my reservation back an hour'}, {'utterance': 'I booked a ride but I need the address needs to be different'}, {'utterance': 'Can you make changes to my booking'}, {'utterance': 'modify transportation'}, {'utterance': 'modify ride'}],
            dialog_code_hook=None,
            fulfillment_code_hook=None,
            slot_priorities=[],
            intent_closing_setting=None,
        ...
        self.LexIntentRideStatus = aws_lexv2.CfnIntent(
            self, "LexIntentRideStatus",
            bot_id="JH5QVDICLV",
            locale_id="en_US",
            intent_name="RideStatus",
            description=None,
            sample_utterances=[{'utterance': 'Where is my ride'}, {'utterance': "What's the status of my ride "}, {'utterance': 'Check my ride status Is my ride confirmed'}, {'utterance': 'Do I have a ride scheduled'}, {'utterance': 'who is picking me up'}, {'utterance': 'When is my ride'}, {'utterance': 'What rides do I have coming up'}, {'utterance': 'Tell me about my reservation'}, {'utterance': 'Has my ride been scheduled '}, {'utterance': 'Check my booking'}, {'utterance': "What's my ride information"}, {'utterance': 'Can you confirm I have transport arranged'}, {'utterance': 'Do you show a ride for me'}, {'utterance': 'is my ride booked for today'}, {'utterance': 'can you confirm my transportation'}, {'utterance': 'ride status'}, {'utterance': 'status of my ride'}],
            dialog_code_hook=None,
            fulfillment_code_hook=None,
            slot_priorities=[],
            intent_closing_setting=None,
        ...
        self.LexIntentDriverStatus = aws_lexv2.CfnIntent(
            self, "LexIntentDriverStatus",
            bot_id="JH5QVDICLV",
            locale_id="en_US",
            intent_name="DriverStatus",
            description=None,
            sample_utterances=[{'utterance': 'Where is my driver'}, {'utterance': 'How far away is the driver '}, {'utterance': 'When will my driver arrive '}, {'utterance': "What's the ETA"}, {'utterance': "What's the Estimated time"}, {'utterance': 'How long until pickup '}, {'utterance': 'Is my driver on the way '}, {'utterance': 'Track my driver '}, {'utterance': 'How many minutes away is my driver '}, {'utterance': 'When will they get here '}, {'utterance': 'Is the driver close '}, {'utterance': 'How far is the driver'}, {'utterance': 'Give me driver location'}, {'utterance': 'Can you tell me when to expect them'}, {'utterance': 'how much longer until the driver gets here'}, {'utterance': 'i am outside waiting on my ride'}, {'utterance': 'driver status'}],
            dialog_code_hook=None,
            fulfillment_code_hook=None,
            slot_priorities=[],
            intent_closing_setting=None,
        ...
        self.LexLocaleen_US = aws_lexv2.CfnBotLocale(
            self, "LexLocaleen_US",
            bot_id="JH5QVDICLV",
            locale_id="en_US",
            description=None,
            nlu_intent_confidence_threshold=0.4,
            voice_settings={'voiceId': 'Stephen', 'engine': 'neural'}
        )

        self.BedrockModelanthropic_claude_3_sonnet_20240229_v1_0 = aws_bedrockmodel.CfnResource(
            self, "BedrockModelanthropic.claude_3_sonnet_20240229_v1_0",
            model_id="anthropic.claude-3-sonnet-20240229-v1:0",
            arn=self.BedrockModelanthropic_claude_3_sonnet_20240229_v1_0.ref,
            description="Reference-only Bedrock foundation model"
        )

        self.IAMRoleAWSServiceRoleForLexV2Bots_G5GKAZB1D9I = aws_iam.CfnResource(
            self, "IAMRoleAWSServiceRoleForLexV2Bots_G5GKAZB1D9I",
            role_name="AWSServiceRoleForLexV2Bots_G5GKAZB1D9I",
            path="/aws-service-role/lexv2.amazonaws.com/",
            description=None,
            managed_by="Service",
            assume_role_policy_document={'Version': '2012-10-17', 'Statement': [{'Effect': 'Allow', 'Principal': {'Service': 'lexv2.amazonaws.com'}, 'Action': 'sts:AssumeRole'}]}
        )

        self.LogsGroupBotLogs = aws_logs.CfnLogGroup(
            self, "LogsGroupBotLogs",
            log_group_name="BotLogs"
        )

        self.UltimateEnglish = aws_connect.CfnQueue(
            self, "UltimateEnglish",
        ...
        self.ConnectPromptUltimate_Language_Selection = aws_connect.CfnPrompt(
            self, "ConnectPromptUltimate Language Selection",
        ...
        self.UltimateAfterHoursSpanish = aws_connect.CfnQueue(
            self, "UltimateAfterHoursSpanish",
            name="Ultimate After Hours Spanish",
            description="Ultimate After Hours Spanish",
            instance_arn=self.ConnectInstancesrh.value_as_string,
            outbound_caller_config={'OutboundCallerIdName': 'SafeRide', 'OutboundCallerIdNumberId': '199ae2b1-84d0-4620-9ea3-4e18797d1f45', 'OutboundFlowId': '75b8e03f-f5c4-47d7-bb54-89fc84e66ffa'},
            tags=[],
            hours_of_operation_arn=self.ConnectHoursUltimate_After_Hours.ref
        )

        self.ConnectHoursUltimate_After_Hours = aws_connect.CfnHoursOfOperation(
            self, "ConnectHoursUltimate After Hours",
            name="Ultimate After Hours",
            description="Ultimate After Hours",
            config=[{'Day': 'MONDAY', 'StartTime': {'Hours': 20, 'Minutes': 0}, 'EndTime': {'Hours': 0, 'Minutes': 0}}, {'Day': 'MONDAY', 'StartTime': {'Hours': 0, 'Minutes': 1}, 'EndTime': {'Hours': 8, 'Minutes': 0}}, {'Day': 'SUNDAY', 'StartTime': {'Hours': 0, 'Minutes': 0}, 'EndTime': {'Hours': 11, 'Minutes': 59}}],
            time_zone="US/Eastern",
            instance_arn=self.ConnectInstancesrh.value_as_string,
            tags=[]
        )

        self.UltimateAfterHoursEnglish = aws_connect.CfnQueue(
            self, "UltimateAfterHoursEnglish",
