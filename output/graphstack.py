from aws_cdk import (Stack, aws_connect, aws_dynamodb, aws_iam, aws_lambda, aws_lex, aws_logs, aws_s3, custom_resources)
...
class GraphStack(Stack):
    def __init__(self, scope: Construct, id: str, **kwargs):
        ...
        self.LexAliasPROD = aws_lex.CfnBotAlias(
            ...
            bot_alias_locale_settings={'en_US': {'enabled': True}, 'es_US': {'enabled': True}},
        ...
        # Unsupported resource handled via Lambda custom resource
        self.S3Bucketamazonconnectc575c0ad8ab8 = custom_resources.CfnCustomResource(
            self, "S3Bucketamazonconnectc575c0ad8ab8",
            service_token=self.custom_handler_arn.value_as_string,
            properties={"Service": "s3", "OriginalType": "AWS::S3::Resource", **json.loads(r'''{
  ...
  "managed_by": "AWS"
        ...
        # Unsupported resource handled via Lambda custom resource
        self.LexLocalees_US = custom_resources.CfnCustomResource(
            self, "LexLocalees_US",
            service_token=self.custom_handler_arn.value_as_string,
            properties={"Service": "lex", "OriginalType": "AWS::Lex::BotLocale", **json.loads(r'''{
  "bot_id": "JH5QVDICLV",
  "locale_id": "es_US",
  "description": null,
  ...
  "voice_settings": {
    ...
    "engine": "neural"
        ...
        # Unsupported resource handled via Lambda custom resource
        self.LexIntentAgent = custom_resources.CfnCustomResource(
            self, "LexIntentAgent",
            service_token=self.custom_handler_arn.value_as_string,
            properties={"Service": "lex", "OriginalType": "AWS::Lex::Intent", **json.loads(r'''{
  "bot_id": "JH5QVDICLV",
  "locale_id": "en_US",
  "intent_name": "Agent",
  "description": null,
  ...
  "output_contexts": null
        ...
        # Unsupported resource handled via Lambda custom resource
        self.LexIntentCancelRide = custom_resources.CfnCustomResource(
  ...
  "output_contexts": null
        ...
        # Unsupported resource handled via Lambda custom resource
        self.LexIntentFlexRideActivation = custom_resources.CfnCustomResource(
  ...
  "output_contexts": null
        ...
        # Unsupported resource handled via Lambda custom resource
        self.LexIntentReservation = custom_resources.CfnCustomResource(
  ...
  "output_contexts": null
        ...
        # Unsupported resource handled via Lambda custom resource
        self.LexIntentRescueRide = custom_resources.CfnCustomResource(
  ...
  "output_contexts": null
        ...
        # Unsupported resource handled via Lambda custom resource
        self.LexIntentFallbackIntent = custom_resources.CfnCustomResource(
  ...
  "output_contexts": null
        ...
        # Unsupported resource handled via Lambda custom resource
        self.LexIntentModifyRide = custom_resources.CfnCustomResource(
  ...
  "output_contexts": null
        ...
        # Unsupported resource handled via Lambda custom resource
        self.LexIntentRideStatus = custom_resources.CfnCustomResource(
  ...
  "output_contexts": null
        ...
        # Unsupported resource handled via Lambda custom resource
        self.LexIntentDriverStatus = custom_resources.CfnCustomResource(
  ...
  "output_contexts": null
        ...
        # Unsupported resource handled via Lambda custom resource
        self.LexLocaleen_US = custom_resources.CfnCustomResource(
            self, "LexLocaleen_US",
            service_token=self.custom_handler_arn.value_as_string,
            properties={"Service": "lex", "OriginalType": "AWS::Lex::BotLocale", **json.loads(r'''{
  "bot_id": "JH5QVDICLV",
  ...
  "voice_settings": {
    ...
    "engine": "neural"
        ...
        # Unsupported resource handled via Lambda custom resource
        self.BedrockModelanthropic_claude_3_sonnet_20240229_v1_0 = custom_resources.CfnCustomResource(
            self, "BedrockModelanthropic.claude_3_sonnet_20240229_v1_0",
            service_token=self.custom_handler_arn.value_as_string,
            properties={"Service": "bedrock", "OriginalType": "Unresolved::BedrockModel", **json.loads(r'''{
  ...
  "description": "Reference-only Bedrock foundation model"
        ...
        # Unsupported resource handled via Lambda custom resource
        self.IAMRoleAWSServiceRoleForLexV2Bots_G5GKAZB1D9I = custom_resources.CfnCustomResource(
            self, "IAMRoleAWSServiceRoleForLexV2Bots_G5GKAZB1D9I",
            service_token=self.custom_handler_arn.value_as_string,
            properties={"Service": "iam", "OriginalType": "AWS::Iam::Resource", **json.loads(r'''{
